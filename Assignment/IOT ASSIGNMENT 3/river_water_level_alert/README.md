...
The ESP32 calculates both the current distance and a rolling average.
The measured value is compared with predefined thresholds.
According to the water level, the system activates the appropriate LED and buzzer alert.
Distance values and alert levels are uploaded to ThingSpeak for remote monitoring.
The Serial Monitor displays live readings and server response.
Alert Levels
Status	Distance
