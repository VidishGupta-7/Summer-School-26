...
Based on threshold values, the controller automatically operates the Heater, Fan, and Grow Light.
Sensor values and system status are displayed on the LCD.
The same information is transmitted over MQTT for remote monitoring.
