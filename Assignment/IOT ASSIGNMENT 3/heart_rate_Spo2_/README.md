...
The ESP32 reads the analog value from GPIO 34.
A rolling average filter smooths the sensor readings.
The filtered value is converted into simulated Heart Rate and SpO₂ values.
The controller compares the values against predefined thresholds.
If abnormal conditions are detected, the red LED turns ON.
All readings are displayed on the Serial Monitor in CSV format for logging.
Alert Conditions
Condition	Alert
...
Add an LDR, resistors, and a Red LED.
