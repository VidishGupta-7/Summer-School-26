...
Temperature { "value": 28.5, "unit": "C", "ts": 1234567890 }

Humidity { "value": 65, "unit": "%", "ts": 1234567890 }
...
Folder Structure week4/ └── mqtt_sensor/ ├── mqtt_sensor.ino ├── README.md └── screenshots/ └── mqtt_messages.png

Simulation Note This project was developed using Wokwi with a DHT22 sensor because DHT11 is unavailable in the simulator. MQTT communication was tested successfully using the HiveMQ public broker.
